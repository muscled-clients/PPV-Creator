...
-- Create policies for influencer_profiles
...
CREATE POLICY "Brands can view own profile" ON public.brand_profiles
  FOR SELECT USING (auth.uid() = user_id);
...
-- IMPORTANT: Function to handle new user creation
